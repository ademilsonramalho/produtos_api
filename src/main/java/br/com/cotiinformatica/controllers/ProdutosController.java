...
public class ProdutosController {
	...
	@CrossOrigin("http://localhost:4200") // esse servidor tem permissão de chamar esta API
	...
	@CrossOrigin("http://localhost:4200")
	@ApiOperation("Serviço para consultar um produto.")
	@GetMapping("/api/produtos/{id}")
	public ResponseEntity<ProdutosGetDto> getById(@PathVariable("id") Integer id) {
